    ...
    private void initComponents() {
        ...
        jPanelToolBarLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelToolBarLayout.createSequentialGroup()
                ...
                .addComponent(jLabelToolBarSave, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void jLabelToolBarSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelToolBarSaveMouseClicked
        try {
            if (!jTextFieldName.getText().equals("")){
                ...
                JOptionPane.showMessageDialog(rootPane, "Oba, voce adicionou um novo projeto!");
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(rootPane, "Você deve inserir um novo para o projeto!");
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, "Houve um erro ao salvar o projeto :/ \n"+e.getMessage());
        }
